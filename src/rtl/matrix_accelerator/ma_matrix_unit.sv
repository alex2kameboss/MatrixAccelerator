...
assign operands_addr_gen_en = en & (rs_addr_en | config_intf.start);
...
always @( posedge data_intf.clk, negedge data_intf.rst_n )
    ...
    if ( en )                           start_delayed <= config_intf.start;
